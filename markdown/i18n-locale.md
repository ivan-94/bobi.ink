...
![Cover](https://bobi.ink/images/i18n-locale/Untitled.png)
...
![子域划分](https://bobi.ink/images/i18n-locale/Untitled%201.png)
...
![小程序](https://bobi.ink/images/i18n-locale/Untitled%202.png)
...
![碎片化](https://bobi.ink/images/i18n-locale/Untitled%203.png)
...
![注册](https://bobi.ink/images/i18n-locale/Untitled%204.png)
...
![i18n-ally](https://bobi.ink/images/i18n-locale/Untitled%205.png)
...
![i18n-ally](https://bobi.ink/images/i18n-locale/Untitled%206.png)
...
1. 使用的框架。默认情况下，i18n ally 会分析项目根目录下的 package.json, 确定你使用的 i18n 框架，它支持了很多常见的 i18n 库，比如 `vue-i18n`, `react-i18next`。
   ...
   ![OUTPUT](https://bobi.ink/images/i18n-locale/Untitled%207.png)
