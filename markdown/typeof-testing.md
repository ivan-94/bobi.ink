...
![](https://bobi.ink/images/typeof-testing/ab.png)
...
举一个典型的例子, 最近把我[坑得有点惨](https://juejin.im/pin/5d1ecb656fb9a00259a176a5)的iOS13的发布计划:
...
![](https://bobi.ink/images/typeof-testing/firefox.png)
...
![](https://bobi.ink/images/typeof-testing/accept.png)
...
![](https://bobi.ink/images/typeof-testing/acs.png)
...
![](https://bobi.ink/images/typeof-testing/brw.png)
...
当然为了**测试跨浏览器兼容性**，还要一些辅助工具，例如[BrowserStack](https://www.browserstack.com/), 对于我们这些小团队，只能下一堆Portable(_Portable浏览器运行时相互隔离的, 所以不会存在配置文件等冲突问题_) 浏览器，手工测试了。
...
![](https://bobi.ink/images/typeof-testing/black-box.png)
...
关于黑盒测试的优缺点以及测试类型可以看[这里](https://www.softwaretestinghelp.com/black-box-testing/)
...
![](https://bobi.ink/images/typeof-testing/wzr.png)
...
![](https://bobi.ink/images/typeof-testing/comp.png)
...
![](https://bobi.ink/images/typeof-testing/nightwatch.png)

因为和**系统测试**很相似，所以它们也被经常拿来[比较](https://www.softwaretestinghelp.com/system-vs-end-to-end-testing/)
...
![](https://bobi.ink/images/typeof-testing/part.png)
...
![](https://bobi.ink/images/typeof-testing/explorer.png)
...
![](https://bobi.ink/images/typeof-testing/gr.jpg)
...
![](https://bobi.ink/images/typeof-testing/blue-screen.jpg)
...
![](https://bobi.ink/images/typeof-testing/ingr.png)
...
![](https://bobi.ink/images/typeof-testing/perf.png)
...
![](https://bobi.ink/images/typeof-testing/monkey-testing.jpg)
...
![](https://bobi.ink/images/typeof-testing/mut.png)
...
![](https://bobi.ink/images/typeof-testing/bug-fix.gif)
...
在前端中[组件快照测试(Snapshot Testing)](https://jestjs.io/docs/en/snapshot-testing)和一些[CSS UI测试](https://github.com/HuddleEng/PhantomCSS)，都是属于回归测试类型,它们的原理都是和上一次测试生成的结果进行比对，以确保没有意外的修改:

![](https://bobi.ink/images/typeof-testing/phantomcss.png)
...
![](https://bobi.ink/images/typeof-testing/smoke.png)
...
![](https://bobi.ink/images/typeof-testing/sec.png)
...
![](https://bobi.ink/images/typeof-testing/note7.jpg)
...
![](https://bobi.ink/images/typeof-testing/review.jpg)
...
![](https://bobi.ink/images/typeof-testing/str.jpg)
...
![](https://bobi.ink/images/typeof-testing/unit-test.png)
...
![](https://bobi.ink/images/typeof-testing/bdd.png)
...
![](https://bobi.ink/images/typeof-testing/glassbox.jpg)
...
![](https://bobi.ink/images/typeof-testing/all.png)
