...
<center>
<img src="/images/05/awesome.png" width="400" />
</center>
...
| 扩展性       | 强，通过插件扩展 wepack 配置                                                         | 弱, 强约定, 无法配置 webpack，可以 eject, 然后手工配置；支持 babel-macro | 中(可以配置 babel，postcss，Typescript); 提供了 Node API; 支持插件扩展文件类型 |
| 多页面       | 支持                                                                                 | -                                                                        | 支持                                                                           |
...
<center>
  <img src="/codes/vue-plugin.png" width="600" />
</center>
...
<center>
  <img src="/images/05/vue-service-struct.png" width="700" />
</center>
